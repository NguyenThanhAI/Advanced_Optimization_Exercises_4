...
\begin{document}
    ...
    \begin{loigiai}
        ...
        Nhưng với hàm $x_1^2 - 2x_1 + x_2^2 - 3=(x_1 - 1)^2 + x_2^2 - 4$ có dạng là một đường tròn
        ...
        Vậy $\varphi$ tương ứng với $\cos \varphi$ không là nghiệm của phương trình $\dfrac{d f(\varphi)}{d \varphi}=0$.
        ...
        đạt được khi $\begin{cases} x_1^* = \dfrac{\sqrt{13} - 6}{\sqrt{13}} \\ x_2^* = - \dfrac{4}{\sqrt{13}} \end{cases}$
    \end{loigiai}
