...
\begin{document}
    ...
    \begin{loigiai}
        ...
        \begin{itemize}
            ...
            \end{equation*}
            Ta kiểm tra ma trận Hessian $\nabla^2 L= \begin{pmatrix} \dfrac{\partial^2 L}{\partial x_1^2} & \dfrac{\partial^2 L}{\partial x_1 \partial x_2} \\ \dfrac{\partial^2 L}{\partial x_2 \partial x_1} & \dfrac{\partial^2 L}{\partial x_2^2} \end{pmatrix} $ tại các giá trị $(x_1, x_2, \lambda)$ đã được tính ở trên.
            ...
            Vì vậy $\nabla^2 L \Big( \lambda = - \dfrac{\sqrt{13}}{4} \Big)$ là ma trận xác định âm. Vậy các nghiệm $(x_1, x_2)$ tương ứng với $\lambda = -\dfrac{\sqrt{13}}{4}$ đã được tính ở trên là một cực đại và không phải là đáp án của bài toán.
            \item Với $\lambda =  \dfrac{\sqrt{13}}{4}$:
            \begin{equation*}
                \Rightarrow \begin{cases} x_1 = \dfrac{2 \dfrac{\sqrt{13}}{4}-3}{2 \dfrac{\sqrt{13}}{4}}=\dfrac{\sqrt{13}-6}{\sqrt{13}} \\ x_2 = - \dfrac{1}{\dfrac{\sqrt{13}}{4}}=-\dfrac{4}{\sqrt{13}} \\ \lambda = \dfrac{\sqrt{13}}{4} \end{cases}
            \end{equation*}
            ...
            Vậy nghiệm tối ưu của bài toán tối ưu là:
