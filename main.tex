...
\begin{document}
    ...
    \begin{loigiai}
        ...
        \begin{enumerate} [wide, labelwidth=!, labelindent=0pt,label=\textbf{\arabic*}.]
            ...
            Ta xét hàm số $l(x) = Ax - y$. Ta nhận thấy hàm $l(x) - l(0) = Ax - y - (-y)=Ax$ là hàm tuyến tính.
            Vì vậy hàm số $l(x)$ là hàm affine.

            Bài toán tối ưu hóa trên có $f(x)$ là hàm lồi, không có ràng buộc bất đẳng thức và ràng buộc đẳng thức $l(x)=0$ với $l(x)$ là hàm affine.
    ...
    \begin{loigiai}
        ...
        \begin{equation*}
            \mathcal{D}_I = \lbrace (x_1, x_2) \in \mathbb{R}^2 \vert 3x_1 + 2x_2 \geq 0 \rbrace
        \end{equation*}

        \begin{equation*}
            \mathcal{D}_{II} = \lbrace (x_1, x_2) \in \mathbb{R}^2 \vert 3x_1 + 2x_2 < 0 \rbrace
        \end{equation*}
        ...
        \begin{equation*}
            \Rightarrow \overrightarrow{IH}=\lbrack a - 1, b \rbrack ^T
        \end{equation*}
        ...
        \begin{equation*}
            \begin{aligned}
            &\begin{cases}
                \overrightarrow{IH} = k \lbrack 3, 2 \rbrack ^T \\
                \lVert IH \rVert = R = 2 \\
                H \in \mathcal{D}_{II}
            \end{cases} \\
            ...
            \end{cases} \\
            \Leftrightarrow & \begin{cases}
                \lbrack a - 1, b \rbrack ^T = k\lbrack 3, 2 \rbrack ^T \\
                \sqrt{(a - 1)^2 + b^2} = 2 \\
                3a + 2b < 0
            \end{cases} \\
            \Leftrightarrow & \begin{cases}
        ...
        Dấu "=" của bất đẳng thức (\ref{eq:BDT}) xảy ra khi và chỉ khi:
    ...
    \begin{tikzpicture}
        ...
        {$-1$, $\dfrac{\sqrt{13} - 6}{\sqrt{13}}$, $3$} % hàng 1 cột 2
